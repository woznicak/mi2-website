...
**Call for PhD Student: Research Opportunity in Foundation Model Readteaming**

We are seeking a highly motivated and talented PhD student to join MI2.AI research team in the exciting field of foundation model readteaming. As the advancements development of AI models, it becomes crucial to ensure the robustness and security of the foundation models that underlie these advancements.

**Project Description:**

The selected PhD student will work on investigating potential vulnerabilities and biases in foundation models, such as language models (one position) and 2D/3D computer vision models (second position). Readteaming involves conducting adversarial assessments to identify weaknesses, uncover potential attack vectors, and develop defensive strategies for foundation models. The research will explore various aspects, including data poisoning attacks, adversarial samples generation, and the development of countermeasures.
...
We look forward to receiving your applications and welcoming an enthusiastic and dedicated PhD student to contribute to our foundation model readteaming research endeavors.


Apply before **June 30 the end of the day** (the sooner the better).
