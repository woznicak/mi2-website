# MI²<span style="color:red">Red</span>Team  {-}

**MI²<span style="color:red">Red</span>Team** analyses machine and deep learning predictive models through the lens of AI explainability, fairness, security and human trust. We develop methods and tools for explanatory model analysis and apply them in practice.

####  {-}

**MI²RedTeam** is a group of researchers experienced in [XAI](https://doi.org/10.1016/j.inffus.2019.12.012) who perform a rigorous evaluation of AI solutions in order to improve their transparency and security. We apply state-of-the-art methods and introduce new ones to tailor our analysis to the specific predictive task. 

Our current *core* research topics of interest include:

1. [**ARES**] Attack-Resistant Explanations towards Secure AI, i.e. a critical evaluation of the state-of-the-art analysis techniques 
2. [**xSurvival**] Explanatory analysis of machine learning survival models
3. [**Large Model Analysis**] Explanatory analysis of large models, e.g. transformers
...
- [InteractiveEMA](https://iema.drwhy.ai) towards human-model interaction in explainable machine learning for tabular data
...
- [Fooling PD](https://arxiv.org/abs/2105.12837) & [Manipulating SHAP](https://doi.org/10.1609/aaai.v36i11.21590) for stress-testing widely-applied explanation methods
...
- [dalex](http://python.drwhy.ai) for explainable and fair machine learning in Python
...
- In **medicine**, we analyzed hundreds of models predicting among others: [survival in uveal melanoma eye cancer](https://doi.org/10.1016/j.ejca.2022.07.031), [survival in sepsis](https://doi.org/10.3390/cells11152433), [type of lung cancer](https://doi.org/10.3390/cancers14020439), [lung cancer risk in screening](https://doi.org/10.3390/app12041926), [lung cancer mortality](https://doi.org/10.1007/978-3-030-37446-4_13), [COVID-19 mortality](https://doi.org/10.1609/aaai.v35i18.17874), [progression of Alzheimer’s disease](https://doi.org/10.1186/s40708-022-00165-5).
...
- In **football analytics**, we analyzed [expected goal models for performance analysis](https://arxiv.org/abs/2206.07212).
- ...